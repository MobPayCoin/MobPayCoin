...
unsigned int nStakeMaxAge = 35 * 24 * 60 * 60; // 35 days
...
const string strMessageMagic = "Mobilepaycoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Mobilepaycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "China's Cities Need $1 Trillion Green Finance to Cut Pollution";
        CTransaction txNew;
        txNew.nTime = 1465313645;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1465313645;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 755066 : 0;



         //// debug print
        assert(block.hashMerkleRoot == uint256("0x355201311dab147c38aa3ad1b50dc5690049429077d8fd95a951ed757bd393d7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x02, 0xb3, 0xc2, 0xf4 };
